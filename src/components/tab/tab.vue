...
export default {
  ...
  computed: {
    ...
    barClass() {
      return {
        "cy-tab-ink-bar-transition-forward": this.direction === "forward",
        "cy-tab-ink-bar-transition-backward": this.direction === "backward"
      };
    },
    scrollable() {
      return this.childrenNumber > this.scrollThreshold;
    }
  },
  watch: {
